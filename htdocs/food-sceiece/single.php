          ...
          <article id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
            ...
            <div class="post_content">
              ...
              <div class="content">
                <?php the_content(); ?>
                <?php wp_link_pages() ?>
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/dummy/01.jpg" alt="">
              </div>
            </div>
                ...
                <div class="category">
                  <div class="category_list">
                    <?php foreach ($categories as $category) : ?>
                      <div class="category_item"><a href="<?php get_category_link($category); ?>" class="btn btn-sm is-active"><?= $category->name; ?></a></div>
                    <?php endforeach; ?>
                  </div>
                </div>
              <?php endif; ?>
